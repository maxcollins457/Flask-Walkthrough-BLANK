...
def connect_to_database():
    ...
    Returns: psycopg2 connection or, If unsuccessful, returns the error recieved
    '''

    # Connect to your local database here using psycopg2.connect
    # Return the connection
    # Use a try execpt to handle any errors
...
def course_name_filter(course_names):
    menu_data = dict()
